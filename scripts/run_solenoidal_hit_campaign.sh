...
run_and_postprocess 0.25 110.0 "solenoidal_Mt025_N512_CFL_0p05"

# Mt = 0.50: approximately 17.5 turnover times
# This starts only after the Mt=0.25 case finishes successfully.
run_and_postprocess 0.50 55.0 "solenoidal_Mt050_N512_CFL_0p05"

echo
echo "============================================================"
echo "BOTH HIT SIMULATIONS AND ALL POST-PROCESSING COMPLETED"
echo "============================================================"
